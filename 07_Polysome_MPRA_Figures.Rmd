...
```{r}
poly_MPRA <- read_csv("~/Hsieh Lab/Project- MPRA/Polysome Computational Analysis/All_Polysome_MPRA_results.csv") %>%
...
GSEA
```{r}
GSEA_poly <- read_csv("~/Hsieh Lab/Project- MPRA/GSEA_translation.csv") #from MSigDB
