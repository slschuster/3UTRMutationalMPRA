...
```{r}
#import count tables
control_counts <- read_delim("H:/hsiehlab/MAIN_DATA/UTR_Project_hg38/IVT_librray_April2022_v2/count_files/v2_strict_150M_Control_ids_with_counts_per_sample.txt", 
    "\t", escape_double = FALSE, trim_ws = TRUE)
WT_counts <- read_delim("H:/hsiehlab/MAIN_DATA/UTR_Project_hg38/IVT_librray_April2022_v2/count_files/v2_strict_150M_WT_ids_with_counts_per_sample.txt",
    "\t", escape_double = FALSE, trim_ws = TRUE)
Mut_counts <- read_delim("H:/hsiehlab/MAIN_DATA/UTR_Project_hg38/IVT_librray_April2022_v2/count_files/v2_strict_150M_Mutant_ids_with_counts_per_sample.txt",
    "\t", escape_double = FALSE, trim_ws = TRUE)
...
IVT_nls <- read.csv("C:/Users/saman/OneDrive/Documents/Hsieh Lab/Project- MPRA/4sU-IVT MPRA Analysis (Actual)/NLS_fit/IVT_nanonorm_1hrnorm_nlsformat.csv")
...
IVT_normalized <- read_delim("C:/Users/saman/OneDrive/Documents/Hsieh Lab/Project- MPRA/4sU-IVT MPRA Analysis (Actual)/IVT_filtered_NanoNorm_1hrNorm.txt", 
    "\t", escape_double = FALSE, trim_ws = TRUE) %>%
...
```{r}
#get motif data
motifs <- read_csv("~/Hsieh Lab/Manuscripts/3'UTR Paper/Tables/v1/TableS4_Determinants_mutation_function.csv")[,-1]
